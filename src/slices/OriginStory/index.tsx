...
const OriginStory: FC<Props> = ({ slice, index }) => {
  ...
  const imageOnRight = d.image_position === true;
        ...
        {isFilled.richText(d.body) ? (
          ...
          <>
            <p>
              ...
              confidential world of fine wine, he established the business in
              2009 after travelling the roads of France for some of the
              greatest houses.
            </p>
            <p>
          ...
          <>
            <p>
              ...
              négociant with a cellar of nearly 15,000 bottles, including some
              of the rarest from Burgundy, Champagne, the Rhône Valley, and
              Bordeaux. These wines are carefully held in a dedicated,
            ...
            <p>
              Our website does not offer online sales: stocks are often limited
              and constantly moving. To receive our current tariff, please
  ...
  return (
    ...
    >
      <div
        className={`${styles.grid} ${imageOnRight ? styles.imageRight : ""}`}
      >
        {imageOnRight ? (
          <>
            {text}
